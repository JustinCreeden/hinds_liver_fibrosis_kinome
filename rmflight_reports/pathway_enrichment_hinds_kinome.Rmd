...
save_loc = here::here("rmflight_reports/pathway_enrichment_2021-09-29")
...
```{r go_enrichment}
go_all = readRDS(here::here("rmflight_reports/go_all.rds"))
go_bp = readRDS(here::here("rmflight_reports/go_bp.rds"))
...
```{r kegg_enrichment}
kegg_annotation = readRDS(here::here("rmflight_reports/kegg_annotation.rds"))
...
reactome_annotation = readRDS(here::here("rmflight_reports/reactome_annotation.rds"))
...
export_pathway_tables(list(KEGG = kegg_table,
                      ...
                      pathway_file = here::here("rmflight_reports/pathway_tables.xlsx"))
```
