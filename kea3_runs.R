...
kea3_outfile = paste0("kea3_enrichment_", Sys.Date())
save_loc = here::here(kea3_outfile)
dir.create(save_loc)

# get the list of files
kea3_input_lists = dir(here::here("input"), pattern = "^z", full.names = TRUE)
...
saveRDS(kea3_results, here::here(save_loc, "kea3_results.rds"))